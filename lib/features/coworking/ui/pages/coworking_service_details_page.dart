...
import 'package:aina_flutter/features/coworking/ui/pages/widgets/tariff_card.dart';
        ...
        ...service.gallery.map(
          (image) => slides.Slide(
            ...
            previewImage: slides.PreviewImage(
              ...
              uuid: "",
              url: image.url,
              urlOriginal: image.urlOriginal ?? image.url,
              orderColumn: image.orderColumn ?? 0,
              collectionName: image.collectionName ?? "",
            ),
            order: image.orderColumn ?? 0,
          ),
        ),
    ];
