...
class HomeTicketsPage extends ConsumerStatefulWidget {
  final bool? isFromQr;

  const HomeTicketsPage({
    super.key,
    this.isFromQr,
  });

  @override
  ConsumerState<HomeTicketsPage> createState() => _HomeTicketsPageState();
}

class _HomeTicketsPageState extends ConsumerState<HomeTicketsPage> {
  @override
  void initState() {
    super.initState();
