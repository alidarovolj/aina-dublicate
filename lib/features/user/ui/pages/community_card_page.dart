...
import 'package:aina_flutter/shared/ui/widgets/custom_dropdown.dart';
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                SvgPicture.asset(
                  'lib/app/assets/icons/info-error.svg',
                  width: 24,
                  height: 24,
                  colorFilter:
                ...
                InkWell(
                  ...
                  child: Row(
                    children: [
                      ...
                      SvgPicture.asset(
                        'lib/app/assets/icons/share_arrow.svg',
                        width: 24,
                        height: 24,
                              ...
                              children: [
                                ...
                                CustomTextField(
                                  ...
                                  prefixIconWidget: _buildContactIcon(
                                      'lib/app/assets/icons/contacts/telegram.svg'),
                                ),
                                const SizedBox(height: 8),
                                CustomTextField(
                                  ...
                                  prefixIconWidget: _buildContactIcon(
                                      'lib/app/assets/icons/contacts/whatsapp.svg'),
                                ),
                                const SizedBox(height: 8),
                                CustomTextField(
                                  ...
                                  enabled: _status != 'REVIEW',
                                  prefixIconWidget: _buildContactIcon(
                                      'lib/app/assets/icons/contacts/linkedin.svg'),
                                ),
                                const SizedBox(height: 8),
                                CustomTextField(
                                  ...
                                  prefixIconWidget: _buildContactIcon(
                                      'lib/app/assets/icons/contacts/envelope.svg'),
                                ),
                                const SizedBox(height: 8),
                                CustomTextField(
                                  ...
                                  keyboardType: TextInputType.phone,
                                  prefixIconWidget: _buildContactIcon(
                                      'lib/app/assets/icons/contacts/phone.svg'),
                                ),
                              ],
                            ),
                          ),
