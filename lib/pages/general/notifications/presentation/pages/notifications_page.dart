...
import 'package:aina_flutter/app/providers/requests/notifications/notifications_provider.dart';
        ...
        data: (notificationsResponse) {
          ...
          try {
            ...
            if (notifications != null && notifications.isNotEmpty) {
              debugPrint('Первое уведомление: ${notifications.first}');
            }
          } catch (e) {
            debugPrint('Ошибка при получении списка уведомлений: $e');
          }
          ...
          notifications.sort((a, b) {
            ...
            try {
              ...
              debugPrint('Ошибка при сортировке дат: $e');
            }
          ...
          for (var notification in notifications) {
            if (notification is Map &&
              ...
              try {
                ...
                debugPrint('Ошибка при группировке уведомления: $e');
              }
            }
          }
